 ...
 */ ?>
<div class="logo-area notfound">
    <?php if ($yeasfe['logo']['url']) : ?>
        <a href='<?php echo esc_url(home_url('/')); ?>' >
            <img class="img-responsive logo " src='<?php echo $yeasfe['logo']['url']; ?>' alt='<?php echo esc_attr(get_bloginfo('name', 'display')); ?> Logo'>
            <h1 class="goback">Go back to Home</h1>
        </a>
...
<style>
    ...
    .logo-area.notfound img {
           width: auto;
    background: rgba(186, 187, 189, 0);
    margin-bottom: 60px;
    }
    .logo-area {
        text-align: center;
